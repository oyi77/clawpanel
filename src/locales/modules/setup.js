...
export default {
  ...
  envHintLocalReinstall: _('或者，你也可以在本机重新安装 OpenClaw（使用下方的「一键安装」）。', 'Or, reinstall OpenClaw locally using the install button below.', '或者，你也可以在本機重新安裝 OpenClaw（使用下方的「一鍵安裝」）。'),
