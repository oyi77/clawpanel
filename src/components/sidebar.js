...
function NAV_ITEMS_FULL() { return [
  ...
  },
  {
    ...
    items: [
      ...
      { route: '/workflow', label: t('sidebar.workflow'), icon: 'workflow' },
    ]
  },
  {
    section: '',
...
const ICONS = {
  ...
  workflow: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z"/><path d="M10 7h4M7 10v4M17 10v4M10 17h4"/></svg>',
}
